...
const ReviewRequestPage = () => {
  ...
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-lato items-center justify-start mx-auto pb-[141px] w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col gap-[43px] items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[94%] md:w-full">
              <div className="flex md:flex-col flex-row gap-9 items-start justify-start w-[84%] md:w-full">
                <SelectBox
                ...
                />
                <div className="flex flex-col gap-3 items-end justify-start md:mt-0 mt-[7px] w-4/5 md:w-full">
                  <Text
                  ...
                  <div className="bg-white-A700 border border-blue_gray-100_d9 border-solid flex flex-col font-sourcesanspro gap-[35px] items-center justify-start p-4 shadow-bs7 w-full">
                    <Text
                      className="mt-[3px] md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-900_01"
                      size="txtSourceSansProRegular32"
                    >
                      Free Footage Request
                    </Text>
                    <div className="flex flex-col font-lato items-center justify-start mb-[115px] w-full">
                      <div className="flex flex-col gap-[42px] items-start justify-start w-full">
                        <div className="flex flex-col items-start justify-start w-full">
                          ...
                          <div className="flex flex-row sm:gap-10 items-center justify-between mt-3.5 w-[77%] md:w-full">
                            <div className="flex flex-col gap-1.5 items-start justify-start w-1/4">
                              <div className="flex flex-col items-center justify-start">
                                <Text
                                  className="text-base text-blue_gray-900_01"
                                  size="txtLatoMedium16"
                            ...
                            <div className="flex flex-col gap-1.5 items-start justify-start w-[28%]">
                              <div className="flex flex-col items-center justify-start w-full">
                                <Text
                                  className="text-base text-blue_gray-900_01"
                                  size="txtLatoMedium16"
                          ...
                          <div className="flex flex-col items-start justify-start mt-3.5 pb-1 pr-1 w-full">
                        ...
                        <div className="flex flex-col gap-2 items-start justify-start w-[19%] md:w-full">
                          <div className="flex flex-col items-center justify-start w-full">
                            <Text
                              className="text-base text-blue_gray-900_01"
                              size="txtLatoMedium16"
              ...
              <div className="flex sm:flex-col flex-row font-lato md:gap-10 items-center justify-between mt-40 pl-4 w-full">
